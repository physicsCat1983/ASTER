...
<div id="wrapper">
		...
		<div id="sidebar">
			<nav>
				<ul>
					...
					<li class="active"><a href="technology.php"><firstletter>T</firstletter>echnology</a></li>
	...
	<div class="column-center">
		...
		<div id="discussion-board">
			<h1>AS<letter>T</letter>ER</h1>
			<h2>Technology</h2>
			<p class="heading">
				<b>Content for the discussion of all technology related topics.</b>
			</p>
			...
			<div id="content">
				<p id="paragraph">
					Keep checking in for content in our Technology section. We have many things to discuss, learn and do. We are continually striving to perfect ASTER and are eager to
	...
	<div class="column-right">
		...
		<div id="circle-logos">
			<img src="images/logos/technology.png" alt="Technology" title="Technology Logo">
		</div>
		<!-- end of circle-logos -->
