...
<div id="wrapper">
		...
		<div id="sidebar">
			<nav>
				<ul>
					...
					<li class="active"><a href="energy.php"><firstletter>E</firstletter>nergy</a></li>
	...
	<div class="column-center">
		...
		<div id="discussion-board">
			<h1>AST<letter>E</letter>R</h1>
			<h2>Energy</h2>
			<p class="heading">
				<b>Content for the discussion of all energy related topics.</b>
			</p>
			...
			<div id="content">
				<p id="paragraph">
					Keep checking in for content in our Energy section. We have many things to discuss, learn and do. We are continually striving to perfect ASTER and are eager to
	...
	<div class="column-right">
		...
		<div id="circle-logos">
			<img src="images/logos/energy.png" alt="Energy" title="Energy Logo">
		</div>
		<!-- end of circle-logos -->
